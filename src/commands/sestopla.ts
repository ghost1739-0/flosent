...
const TARGET_VOICE_CHANNEL_ID = process.env.TARGET_VOICE_CHANNEL_ID ?? '1500135057078223027';
const TARGET_ROLE_ID = process.env.AKTIFLIK_ROLE_ID ?? '1500135055207567590';
